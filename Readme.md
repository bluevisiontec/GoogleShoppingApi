...
* Download Google Content API Client for PHP Release 2.0.0: https://github.com/google/google-api-php-client/archive/v2.0.0-RC2.tar.gz
...
* After the project is created go to "API Manager" -> "Overview"
* Search for "Content API for Shopping" and enable it
* Next go to "API Manager" -> "Credentials" and click "Add credentials"
* Select "Service account"
  * Select "JSON" as key type
  * Click on "Create"
  * Save the JSON file, you will need to upload it to Magento
...
BlueVisionTec Modules -> GoogleShoppingApi
  ...
  * Google Developer Project Service account JSON key: upload the JSON file here (As downloaded and explained above)
