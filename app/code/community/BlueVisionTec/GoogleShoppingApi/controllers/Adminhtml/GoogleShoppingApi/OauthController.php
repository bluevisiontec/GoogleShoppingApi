...
*/
class BlueVisionTec_GoogleShoppingApi_Adminhtml_GoogleShoppingApi_OauthController extends Mage_Adminhtml_Controller_Action
{ 
	/**
	...
	public function authAction() {
		...
		$client->setApplicationName(BlueVisionTec_GoogleShoppingApi_Model_GoogleShopping::APPNAME);
