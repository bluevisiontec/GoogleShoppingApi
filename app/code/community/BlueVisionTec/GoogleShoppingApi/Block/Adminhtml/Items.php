 ...
 */
class BlueVisionTec_GoogleShoppingApi_Block_Adminhtml_Items extends Mage_Adminhtml_Block_Widget_Grid_Container
{
     ...
     * Preparing layout
     *
     * @return BlueVisionTec_GoogleShoppingApi_Block_Adminhtml_Items
     */
