 ...
 */
class BlueVisionTec_GoogleShoppingApi_Block_Adminhtml_Items_Item extends Mage_Adminhtml_Block_Widget_Grid
{
     ...
     *
     * @return BlueVisionTec_GoogleShoppingApi_Block_Adminhtml_Items_Item
     */
