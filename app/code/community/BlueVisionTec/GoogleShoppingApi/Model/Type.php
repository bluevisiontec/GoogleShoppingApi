 ...
 */
class BlueVisionTec_GoogleShoppingApi_Model_Type extends Mage_Core_Model_Abstract
{
    /**
    ...
    public function convertAttributes($product) {
        ...
        /**
         * @var @string $name
         * @var BlueVisionTec_GoogleShoppingApi_Model_Attribute $attribute
         */
     ...
     *
     * @param string $name
     * @return BlueVisionTec_GoogleShoppingApi_Model_Attribute
     */
     ...
     *
     * @return BlueVisionTec_GoogleShoppingApi_Model_Mysql4_Attribute_Collection
     */
