 ...
 */
class BlueVisionTec_GoogleShoppingApi_Model_Attribute_Default extends BlueVisionTec_GoogleShoppingApi_Model_Attribute
{
    /**
    ...
    public function convertAttribute($product, $shoppingProduct)
    {
        ...
        if (!is_null($value)) {
            ...
            $name = ucwords(str_replace(array('-', '_'), ' ', $this->getName()));
